const dataN = [
    {
        ...
        "img": "assets/lh.jpg",
        "GitHub":"https://github.com/regex-rejects/tech-spotlight" ,
        "Jupyter": "https://www.kaggle.com/code/edenbrekke/tech-spotlight-indeed-data-18may2022/notebook",
        "description": "Tech Spotlight scrapes Indeed.com and returns the frequency of technologies found in all postings scraped. It uses search queries, job title, location, and date of post and returns a file of the most popular technologies. We plotted our findings in a Jupyter Notebook."
    
    },
    {
        "id": 2,
        "projectName": "Do or Doom",
        "img": "assets/do_or_doom.JPG",
